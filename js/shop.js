(function(){
   ...
   size.forEach( function(sz){
      ...
      let totalnum = `<div class="total">
      <label>총 상품금액<span>(수량)</span></label>
      <div><p>${selectPrice}원</p><span>(${selectPrice.count()}개)</span></div>
  </div>`
          const sltp = selectPrice.innerHTML;
          selectPrice.innerHTML = sltp + totalnum;
         }
